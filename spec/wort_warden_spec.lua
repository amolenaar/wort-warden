...
describe("Once configured", function()
  ...
  it("perform a sampling cycle", function()
    ...
    assert.are.equal('{"accel_x": 0.7686767578125, "accel_y": 0.800048828125, "accel_z": 0.8314208984375, "pitch": 43.899104963699, "roll": -42.755890428465, "temperature": 78.106470588235}', mqtt.messages_sent()[1])
  end)

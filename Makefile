...
upload: lint test .uploads/init .uploads/main .uploads/scheduler .uploads/accel .uploads/gy521 .uploads/config .uploads/tilttest	## Upload modified files to the ESP8266
